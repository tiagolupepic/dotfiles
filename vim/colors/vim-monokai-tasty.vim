...
let s:yellow = { "cterm": 228, "gui": "#E6E67A" }
let s:purple = { "cterm": 141, "gui": "#AB9FF0" }
let s:light_green = { "cterm": 148, "gui": "#AADB7B" }
let s:light_blue = { "cterm": 81, "gui": "#7CDCE7" }
let s:magenta = { "cterm": 197, "gui":"#FD6389" }
...
let s:selection_color = { "cterm": 238, "gui": "#373737" }
let s:light_charcoal = { "cterm": 238, "gui": "#292929" }
let s:charcoal = { "cterm": 235, "gui": "#1d1f21" }
...
let s:background = { "cterm": "NONE", "gui": "#1d1f21" }
let s:fdcolumn = { "cterm": "NONE", "gui": "#232526" }
...
call Highlight("Visual", s:none, s:selection_color, s:none)
...
call Highlight("SignColumn", s:grey, s:fdcolumn, s:none)
call Highlight("FoldColumn", s:grey, s:fdcolumn, s:none)
call Highlight("NonText", s:darker_grey, s:none, s:none)
call Highlight("TabLineFill", s:none, s:darker_grey, s:none)
call Highlight("LineNr", s:darker_grey, s:fdcolumn, s:none)
...
call Highlight("PreProc", s:light_blue, s:none, s:none)
