...
fun! s:apply_syntax_highlightings()
  ...
  exec 'hi QuickFixLine guifg=fg guibg=#293739 guisp=NONE gui=NONE cterm=NONE'
  exec 'hi Cursor' . s:fg_cursor_fg . s:bg_cursor_bg
  exec 'hi SpecialKey' . s:fg_nontext
  exec 'hi Search' . s:fg_search_fg . s:bg_search_bg . s:ft_none
  ...
  exec 'hi Directory guifg=#aaaaaa guibg=NONE guisp=NONE gui=NONE cterm=NONE'
