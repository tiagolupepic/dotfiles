...
if s:configuration.transparent_background
  ...
  call s:HL('FoldColumn', s:palette.grey, s:palette.bg6)
  call s:HL('Folded', s:palette.grey, s:palette.bg6)
  call s:HL('SignColumn', s:palette.fg, s:palette.bg6)
endif
...
call s:HL('LineNr', s:palette.grey, s:palette.bg6)
