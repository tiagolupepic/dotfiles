...
call s:Color("Normal",   s:white,  s:background,  s:t_white,  s:t_gray1)
call s:Color("Search",   s:yellow, "NONE",   s:t_yellow, "NONE", "bold")
call s:Color("Title",    s:white,  "NONE",   s:t_white,  "NONE", "bold")

call s:Color("LineNr",       s:gray3, s:foldcolumn,  s:t_gray3, "NONE")
...
call s:Color("Folded",     s:gray4,  s:foldcolumn,  s:t_gray4,  "NONE")
call s:Color("FoldColumn", s:gray3,  s:foldcolumn, s:t_gray3,  s:t_gray1)
...
call s:Color("EndOfBuffer", s:gray1,  s:gray1,  s:t_white,  s:t_gray1)
