...
hl.common = {
    ...
    FoldColumn = {fg = c.fg, bg = c.gutter},
    Folded = {fg = c.fg, bg = c.gutter},
    SignColumn = {fg = c.fg, bg = c.gutter},
    ToolbarLine = {fg = c.fg},
    Cursor = {reverse = true},
    ...
    CursorLineNr = {fg = c.orange, bg = c.gutter},
    LineNr = {fg = c.grey, bg = c.gutter},
...
hl.langs.ruby = {
  rubyTSExtends = colors.Red,
  rubyTSModuleName = colors.Red,
  rubyTSRubyInclude = colors.Purple,
  rubyTSRSpecGroupMethods = colors.Purple,
  rubyTSRSpecMatchers = colors.Blue,
  rubyTSRSpecBeforeAndAfter = colors.Red,
  rubyTSRailsCallback = colors.Red,
  rubyTSRailsResponse = colors.Purple,
  rubyTSRubyEntity = colors.Red,
  rubyTSRubyMacro = colors.Red,
  rubyTSRubyAccessor = colors.Red,
  -- rubyTSPunctBracket = colors.Red
  -- rubyTSRSpecKeyword =colors.Blue
